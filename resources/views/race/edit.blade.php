            ...
            <form action="{{ route('race.update', $race->id) }}" method="post"
                ...
                <fieldset class="fieldset">
                    ...
                    <input type="date"
                        ...
                        name="date" value="{{ $race->date }}"required />
                </fieldset>
                <fieldset class="fieldset">
                ...
                <fieldset class="fieldset">
                    ...
                    <input type="number"
                        class="input input-bordered w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100"
                        name="distance" placeholder="Distancia Recorrida" value="{{ $race->distance }}" required />
                </fieldset>
                <fieldset class="fieldset">
                    ...
                    <textarea
                        ...
                        name="description" placeholder="Descripcion de la Carrera">{{ $race->description }}</textarea>
                </fieldset>
                <fieldset class="fieldset">
                    <legend class="text-gray-700 dark:text-gray-300">Jockey</legend>
                    <input type="text"
                        class="input input-bordered w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100"
                        name="jockey" placeholder="Nombre del Jokey" value="{{ $race->jockey }}" required />
                </fieldset>
                <button type="submit"
                    class="btn bg-yellow-300 hover:bg-yellow-400 dark:bg-yellow-500 dark:hover:bg-yellow-400 text-gray-900 font-bold w-full shadow-sm">Actualizar</button>
            </form>
        </div>
    </div>
