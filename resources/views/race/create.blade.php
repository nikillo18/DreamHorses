    ...
    <div class="drawer-content bg-gray-950 text-white">
        ...
        <div class="p-6 md:p-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <h1 class="text-3xl font-bold text-white">🏁 Crear Carrera</h1>
                <a href="{{ route('race.index') }}" class="btn bg-gray-700 hover:bg-gray-600 text-white mt-4 sm:mt-0">Volver a la Lista</a>
            </div>
            <form action="{{ route('race.store') }}" method="post" class="space-y-4 bg-gray-900 p-6 rounded-lg">
                @csrf
                ...
                <fieldset class="fieldset">
                    <legend class="text-white">Posición</legend>
                    <input type="number" class="input input-bordered w-full bg-gray-800 text-white" name="place"
                ...
                <fieldset class="fieldset">
                    ...
                    <textarea class="textarea textarea-bordered h-24 w-full bg-gray-800 text-white" name="description" placeholder="Descripcion"></textarea>
                </fieldset>
                <fieldset class="fieldset">
                    <legend class="text-white">Jockey</legend>
                    <input type="text" class="input input-bordered w-full bg-gray-800 text-white" name="jockey" placeholder="Nombre del Jokey"
                        required />
                </fieldset>
