    ...
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('training.update', $training->id) }}" method="post" class="space-y-4">
            ...
            <fieldset class="fieldset">
                ...
                <input type="date" class="input input-bordered w-full" name="date" value="{{ $training->date }}"
                    required />
            </fieldset>
            <fieldset class="fieldset">
            ...
            <fieldset class="fieldset">
                ...
                <input type="number" class="input input-bordered w-full" name="duration_minutes" placeholder="Tiempo"
                    value="{{ $training->duration_minutes }}" required />
            </fieldset>
            <fieldset class="fieldset">
                <legend class="fieldset-legend">Tipo de Entrenamiento</legend>
