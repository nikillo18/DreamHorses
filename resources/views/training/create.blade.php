    ...
    <div class="drawer-content bg-gray-50 text-gray-800 dark:bg-gray-900 dark:text-gray-100">
        ...
        <div class="p-6 md:p-8">
            ...
            <form action="{{ route('training.store') }}" method="post"
                class="space-y-4 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                @csrf
                ...
                <fieldset class="fieldset">
                    ...
                    <input type="number"
                        class="input input-bordered w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100"
                        name="distance" placeholder="Distancia Recorrida" required />
                </fieldset>
                <fieldset class="fieldset">
                    <legend class="text-gray-700 dark:text-gray-300">Tiempo</legend>
                    <input type="number"
                        class="input input-bordered w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100"
                        name="duration_minutes" placeholder="Tiempo" required />
                </fieldset>
                <fieldset class="fieldset">
                    <legend class="text-gray-700 dark:text-gray-300">Tipo de Entrenamiento</legend>
                    <input type="text"
                        class="input input-bordered w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100"
                        name="type_training" placeholder="Tipo de Entrenamiento" required />
                </fieldset>
                <fieldset class="fieldset">
                    <legend class="text-gray-700 dark:text-gray-300">Comentarios</legend>
                    <textarea
                        class="textarea textarea-bordered h-24 w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100"
                        name="comments" placeholder="comentarios"></textarea>
                </fieldset>
                <button type="submit"
                    class="btn bg-green-300 hover:bg-green-400 dark:bg-green-600 dark:hover:bg-green-500 text-gray-900 font-bold w-full shadow-sm">Crear</button>
            </form>
        </div>
    </div>
