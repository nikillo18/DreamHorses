    ...
    <div class="drawer-content bg-gray-50 text-gray-800 dark:bg-gray-900 dark:text-gray-100">
        ...
        <div class="p-6 md:p-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100">🏋️‍♀️ Crear Entrenamiento</h1>
            ...
            <form action="{{ route('training.store') }}" method="post" class="space-y-4 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                @csrf
                ...
                <fieldset class="fieldset">
                    ...
                    <textarea class="textarea textarea-bordered h-24 w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100" name="comments" placeholder="comentarios"></textarea>
                </fieldset>
