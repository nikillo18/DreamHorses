...
<div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content bg-gray-950 text-white">
        ...
        <div class="p-6 md:p-8">
            ...
            <form action="{{ route('calendar.update', $calendarEvent->id) }}" method="POST" class="space-y-4 bg-gray-900 p-6 rounded-lg">
                @csrf
                @method('PUT')
                ...
                <fieldset class="fieldset">
                    ...
                    <input type="date" name="event_date" id="event_date" value="{{ $calendarEvent->event_date }}"
                        required class="input input-bordered w-full bg-gray-800 text-white">
                </fieldset>
                <fieldset class="fieldset">
                ...
                <fieldset class="fieldset">
                    ...
                    <textarea name="description" id="description" rows="3" class="textarea textarea-bordered w-full bg-gray-800 text-white">{{ $calendarEvent->description }}</textarea>
                </fieldset>
                <button type="submit" class="btn bg-blue-500 hover:bg-blue-600 text-white font-bold w-full">Actualizar Evento</button>
            </form>
        </div>
    </div>
