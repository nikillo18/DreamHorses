    ...
    <div class="drawer-content bg-gray-950 text-white">
        ...
        <div class="p-6 md:p-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                ...
                <a href="{{ route('calendar.index') }}" class="btn bg-gray-700 hover:bg-gray-600 text-white mt-4 sm:mt-0">Volver a la Lista de Eventos</a>
            </div>
            <form action="{{ route('calendar.store') }}" method="POST" class="space-y-4 bg-gray-900 p-6 rounded-lg">
                @csrf
                <fieldset class="fieldset">
                    <legend class="text-white">Título</legend>
                    <input type="text" name="title" id="title" required class="input input-bordered w-full bg-gray-800 text-white">
                </fieldset>
                <fieldset class="fieldset">
                ...
                <fieldset class="fieldset">
                    <legend class="text-white">Fecha del Evento</legend>
                ...
                <fieldset class="fieldset">
                    <legend class="text-white">Hora del Evento</legend>
                    <input type="time" name="event_time" id="event_time" required class="input input-bordered w-full bg-gray-800 text-white">
                </fieldset>
                <fieldset class="fieldset">
                    <legend class="text-white">Tipo de Evento</legend>
                    <select class="select select-bordered w-full bg-gray-800 text-white" name="category" id="category" required>
                ...
                <fieldset class="fieldset">
                    <legend class="text-white">Descripción</legend>
                    <textarea name="description" id="description" rows="3" class="textarea textarea-bordered w-full bg-gray-800 text-white"></textarea>
                </fieldset>
                <button type="submit" class="btn bg-green-500 hover:bg-green-600 text-white font-bold w-full">Crear Evento</button>
            </form>
        </div>
    </div>
