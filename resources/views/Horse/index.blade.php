...
<div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content bg-gray-50 text-gray-800 dark:bg-gray-900 dark:text-gray-100">
        ...
        <div class="p-6 md:p-8">
            <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-100 mb-6 flex items-center gap-2">
                Listado de Caballos
            </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($horses as $horse)
                    <div
                        ...
                        <div class="space-y-1">
                            <h2 class="text-xl font-semibold text-indigo-600 dark:text-indigo-300">{{ $horse->name }}
                            </h2>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Cuidador: <span
                                    class="text-gray-800 dark:text-gray-100">{{ $horse->caretaker->name ?? 'Sin cuidador' }}</span>
                            </p>
                        </div>
