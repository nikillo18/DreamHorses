    ...
    <div class="drawer-content bg-gray-50 text-gray-800 dark:bg-gray-900 dark:text-gray-100">
        ...
        <div class="p-6 md:p-8 max-w-3xl mx-auto">
            ...
            <form action="{{ route('vet-visits.update', $vetVisit->id) }}" method="POST"
                ...
                <div>
                    <label for="vet_name" class="font-semibold text-gray-700 dark:text-gray-300">Nombre del
                        Veterinario</label>
                ...
                <div>
                    ...
                    <textarea name="diagnosis" id="diagnosis"
                        class="textarea textarea-bordered w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100"
                ...
                <div>
                    <label for="next_visit" class="font-semibold text-gray-700 dark:text-gray-300">Próxima
                        Visita</label>
                ...
                <div class="pt-4">
                    <button type="submit"
                        class="btn bg-yellow-300 hover:bg-yellow-400 dark:bg-yellow-500 dark:hover:bg-yellow-400 text-gray-900 font-bold w-full shadow-sm">💾
